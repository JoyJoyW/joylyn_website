			...
			<div className="max-w-2xl mx-auto">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center space-y-6">
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:joylyn.wang@live.com"
					...
					<div className="flex justify-center gap-6">
						<a href="https://github.com/JoyJoyW" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-900 transition-colors">
						...
						<a href="https://www.linkedin.com/in/joylynwang/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-600 transition-colors">
							<svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
